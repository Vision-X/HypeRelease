      ...
      <Fragment>
          {(this.props.data && this.props.data.map(item => {
            ...
            <div className="card mb-3" key={Math.random(new Date())}>
              ...
              <div className="card-body">
                <a href="https://www.nike.com/us/en_us/c/jordan" target="_blank" rel="noopener noreferrer" className="card-link">Purchase on Nike.com</a>
                <a href="https://stockx.com/retro-jordans" target="_blank" rel="noopener noreferrer" className="card-link">Purchase on StockX</a>
              </div>
            </div>
            )
          })
